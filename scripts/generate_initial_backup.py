...
# ── オリコカード 過去請求金額（3〜5月、ユーザー提示の実数に合わせる）
# 詳細不明な分は「過去請求まとめ」として 1 取引にまとめる。
# 5月は既存32件で ¥75,764 → 差分 ¥74,176 を「請求調整」として追加し
# 合計 ¥149,940 になるよう辻褄合わせ。
personal_transactions += [
    transaction(iso_date(2026, 3, 31), "9.特別出費", "高額投資",
                "3月のオリコ請求まとめ", 97730, ORICO,
                memo="ユーザー提示の過去請求金額"),
    transaction(iso_date(2026, 4, 30), "9.特別出費", "高額投資",
                "4月のオリコ請求まとめ", 264600, ORICO,
                memo="ユーザー提示の過去請求金額"),
    transaction(iso_date(2026, 5, 27), "9.特別出費", "高額投資",
                "5月の請求調整（既存32件との差分）", 74176, ORICO,
                memo="5月合計 ¥149,940 = 既存¥75,764 + 調整¥74,176"),
]
